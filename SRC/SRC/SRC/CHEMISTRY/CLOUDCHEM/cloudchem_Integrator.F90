...
SUBROUTINE INTEGRATE( TIN,       TOUT,      ICNTRL_U, RCNTRL_U,  &
   ...
   USE cloudchem_Util, ONLY : Integrator_Update_Options
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE cloudchem_Parameters, ONLY : NVAR, LU_NONZERO
 USE cloudchem_Global,     ONLY : FIX, RCONST, TIME
 USE cloudchem_Function,   ONLY : Fun, Fun_SPLIT
 USE cloudchem_Rates,      ONLY : Update_SUN, Update_RCONST
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE cloudchem_Parameters,    ONLY : NVAR, LU_NONZERO
 USE cloudchem_Global,        ONLY : FIX, RCONST, TIME
 USE cloudchem_Jacobian,      ONLY : Jac_SP, LU_IROW, LU_ICOL
 USE cloudchem_LinearAlgebra
 USE cloudchem_Rates,         ONLY : Update_SUN, Update_RCONST
!~~~> Input variables
    REAL(kind=dp) :: T, Y(NVAR)
...
END MODULE cloudchem_Integrator
