...
!
   ...
   real(r4) gamma1                ! Term in direct reflect and transmissivity
...
!
   ...
   gamma1(w,uu,g,e) = .50_r4*w*((3._r4*g*(1._r4-w)*uu*uu + 1._r4)/(1._r4-e*e*uu*uu))
   el(w,g)         = sqrt(max(1.e-5,3._r4*(1._r4-w)*(1._r4 - w*g)))
