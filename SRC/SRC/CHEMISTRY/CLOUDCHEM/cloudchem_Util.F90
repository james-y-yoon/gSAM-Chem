...
! ****************************************************************
      ...
      open(20, file='cloudchem.m')
      write(20,*) 'load cloudchem.dat;'
      write(20,990) PREFIX
990   FORMAT(A1,'c = cloudchem;')
      write(20,*) 'clear cloudchem;'
