...
c-------------------------------------------------------	
	...
	integer(4) i,j,k,l,m
	integer(4) vdimids(2), ndimids
	integer(4) ncid,err,zid,timeid,varid
...
!	m=iargc()
	...
	open(2,file=filename,status='old',form='unformatted',action='read')
...
c--------------------------------------------------------
     ...
     &                       len_trim(units),trim(units))
        ...
        print*,long_name
c----------------------------------------------------------
        long_name = 'Tendency of Precipitable Water'
        abbr_name = 'DPW'
        units = 'mm/day'
        call HBUF_read(2,nzm,'QTEND',1,ntime,f,m)
        do i=1,ntime
         tmp(i)=0.
         do k=1,nzm-1
     ...
     &                       len_trim(units),trim(units))
        ...
        err = NF_PUT_VAR_REAL(ncid, varid, tmp)
        print*,long_name
        print*,minval(tmp(1:ntime)),maxval(tmp(1:ntime))

c----------------------------------------------------------
        long_name = 'Saturation Precipitable Water'
        abbr_name = 'PWS'
        units = 'mm'
        call HBUF_read(2,nzm,'QVS',1,ntime,f,m)
        do i=1,ntime
         tmp(i)=0.
         do k=1,nzm-1
          if(p(k).gt.50.) tmp(i)=tmp(i)+rho(k)*f(k+(i-1)*nzm)*dz(k)
         end do
         tmp(i)=tmp(i)*1.e-3
        end do
        err = NF_REDEF(ncid)
...
c--------------------------------------------------------
        long_name = 'Downward LW flux at sfc (Clear Sky)'
        abbr_name = 'LWDSC'
        units = 'W/m2'
        npar = 69
        err = NF_REDEF(ncid)
...
c--------------------------------------------------------
        long_name = 'Downward SW flux at sfc (Clear Sky)'
        abbr_name = 'SWDSC'
        units = 'W/m2'
        npar = 70
        err = NF_REDEF(ncid)
...
c--------------------------------------------------------
     ...
     &                       NF_FLOAT,1,-1.)
        err = NF_ENDDEF(ncid)
        tmp(1:ntime) = parms(npar:npar+nparms*(ntime-1):nparms)*1.e3
        err = NF_PUT_VAR_REAL(ncid, varid, tmp)
        print*,long_name
c--------------------------------------------------------
...
c--------------------------------------------------------
     ...
     &                       NF_FLOAT,1,-1.)
        ...
        print*,long_name
c--------------------------------------------------------
        long_name = 'Top-Soil Temperature'
        abbr_name = 'TSOIL'
        units = 'K'
        npar = 82
        err = NF_REDEF(ncid)
...
c--------------------------------------------------------
     ...
     &                       NF_FLOAT,1,-1.)
        ...
        print*,long_name
c--------------------------------------------------------
        long_name = 'Number of Sunny Cells'
        abbr_name = 'B_ASUNNY'
        units = ''
        npar = 84
        err = NF_REDEF(ncid)
     ...
     &                       NF_FLOAT,1,-1.)
        ...
        print*,long_name
c--------------------------------------------------------
        long_name = 'Number of Shady Cells'
        abbr_name = 'B_ASHADY'
        units = '%'
        npar = 85
        err = NF_REDEF(ncid)
     ...
     &                       NF_FLOAT,1,-1.)
        ...
        print*,long_name
c--------------------------------------------------------
        long_name = 'Wall Temperature (Sunny)'
        abbr_name = 'B_TSUNNY'
        units = 'K'
        npar = 86
        err = NF_REDEF(ncid)
     ...
     &                       NF_FLOAT,1,-1.)
        ...
        print*,long_name
c--------------------------------------------------------
        long_name = 'Wall Temperature (Shady)'
        abbr_name = 'B_TSHADY'
        units = 'K'
        npar = 87
        err = NF_REDEF(ncid)
...
c--------------------------------------------------------
     ...
     &                       NF_FLOAT,1,-1.)
        ...
        print*,long_name
c--------------------------------------------------------
        long_name = 'LW Flux on WALL from Surface'
        abbr_name = 'B_LWWALLS'
        units = 'W/m2'
        npar = 91
        err = NF_REDEF(ncid)
     ...
     &                       NF_FLOAT,1,-1.)
        ...
        print*,long_name
c--------------------------------------------------------
        long_name = 'LW Flux on WALL from Walls'
        abbr_name = 'B_LWWALLW'
        units = 'W/m2'
        npar = 92
        err = NF_REDEF(ncid)
...
c--------------------------------------------------------
     ...
     &                       NF_FLOAT,1,-1.)
        ...
        print*,long_name
c--------------------------------------------------------
        long_name = 'Skin Temperature Street'
        abbr_name = 'B_SKT_STR'
        units = 'K'
        npar = 94
        err = NF_REDEF(ncid)
     ...
     &                       NF_FLOAT,1,-1.)
        ...
        print*,long_name
c--------------------------------------------------------
        long_name = 'Temperature Outside City'
        abbr_name = 'B_T_OUT'
        units = 'K'
        npar = 95
        err = NF_REDEF(ncid)
     ...
     &                       NF_FLOAT,1,-1.)
        ...
        print*,long_name
c--------------------------------------------------------
        long_name = 'Skin Temperature Outside City'
        abbr_name = 'B_SKT_O'
        units = 'K'
        npar = 96
        err = NF_REDEF(ncid)
     ...
     &                       NF_FLOAT,1,-1.)
        ...
        print*,long_name
c--------------------------------------------------------
        long_name = 'Temperature Street Minimum'
        abbr_name = 'B_T_STR_MN'
        units = 'K'
        npar = 97
        err = NF_REDEF(ncid)
        err = NF_DEF_VAR(ncid,trim(abbr_name),NF_FLOAT,
     ...
     &                       NF_FLOAT,1,-1.)
        ...
        print*,long_name
c--------------------------------------------------------
        long_name = 'Temperature Outide City Minimum'
        abbr_name = 'B_T_OUT_MN'
        units = 'K'
        npar = 98
        err = NF_REDEF(ncid)
        err = NF_DEF_VAR(ncid,trim(abbr_name),NF_FLOAT,
     ...
     &                       NF_FLOAT,1,-1.)
        ...
        print*,long_name
c--------------------------------------------------------
        long_name = 'Temperature Street Maximum'
        abbr_name = 'B_T_STR_MX'
        units = 'K'
        npar = 99
        err = NF_REDEF(ncid)
        err = NF_DEF_VAR(ncid,trim(abbr_name),NF_FLOAT,
     ...
     &                       NF_FLOAT,1,-1.)
        ...
        print*,long_name
c--------------------------------------------------------
        long_name = 'Temperature Outide City Maximum'
        abbr_name = 'B_T_OUT_MX'
        units = 'K'
        npar = 100
        err = NF_REDEF(ncid)
        err = NF_DEF_VAR(ncid,trim(abbr_name),NF_FLOAT,
...
c--------------------------------------------------------
     ...
     &                       NF_FLOAT,1,-1.)
        ...
        print*,long_name
c--------------------------------------------------------
        long_name = 'Surface Stress (Observed)'
        abbr_name = 'TAU_OBS'
        units = 'N/m2'
        npar = 112
        err = NF_REDEF(ncid)
     ...
     &                       NF_FLOAT,1,-1.)
        ...
        print*,long_name
c--------------------------------------------------------
        long_name = 'Temperature at 2-m (Observed)'
        abbr_name = 'T2m_OBS'
        units = 'K'
        npar = 113
        err = NF_REDEF(ncid)
     ...
     &                       NF_FLOAT,1,-1.)
        ...
        print*,long_name
c--------------------------------------------------------
        long_name = 'Water Vapor at 2-m (Observed)'
        abbr_name = 'Q2m_OBS'
        units = 'g/kg'
        npar = 114
        err = NF_REDEF(ncid)
     ...
     &                       NF_FLOAT,1,-1.)
        ...
        print*,long_name
c--------------------------------------------------------
        long_name = 'Wind Speed at 10-m (Observed)'
        abbr_name = 'VEL10m_OBS'
        units = 'm/s'
        npar = 115
        err = NF_REDEF(ncid)
        err = NF_DEF_VAR(ncid,trim(abbr_name),NF_FLOAT,
