...
integer, parameter :: ny0=4096
integer, parameter :: nx=8192
!integer, parameter :: ny0=3072
!!integer, parameter :: ny0=4608
!integer, parameter :: nx=9216
real, parameter :: dy0 = 2. ! spacing at the poles
real, parameter :: dx = 360./nx
integer, parameter :: ny1 = 1 !15 ! number of cells around poles with dy0
real, parameter :: lat0 = 90.-ny1*dy0 ! latitude above which grid spacing is dy0
integer, parameter :: ny = (ny0-2*ny1)/2+1
